...
namespace Dwapi.Crs.SharedKernel.Tests.TestData.TestData
{
    public class TestDataFactory
    {
        ...
        public static List<Facility> TestFacilityWithPatients(int count = 2, int childcount = 3)
        {
            ...
            foreach (var facility in facilities)
            {
                n++;
                facility.SiteCode = n;
                facility.ClientRegistries = Builder<ClientRegistry>.CreateListOfSize(childcount)
                    .All()
        ...
        public static List<ClientRegistry> TestClients(int siteCode, Guid facilityId, int count = 5)
        {
            var patientIndices = Builder<ClientRegistry>.CreateListOfSize(count)
