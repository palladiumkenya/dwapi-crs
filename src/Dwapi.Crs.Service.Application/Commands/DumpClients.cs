...
namespace Dwapi.Crs.Service.Application.Commands
{
   public class DumpClients:IRequest<Result>
    ...
    public class DumpClientsHandler:IRequestHandler<DumpClients,Result>
    {
        ...
        public DumpClientsHandler(CrsSettings crsSettings, IMapper mapper, ICrsDumpService crsDumpService, IRegistryManifestRepository manifestRepository, IClientRepository clientRepository)
        {
